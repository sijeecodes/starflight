...
var createPlayer = function() {
  ...
  var geometry = new THREE.BoxGeometry( 12.3, 0.8, 0.8, 2, 2 );
  ...
  bodyCollisionCheckBox.geometry.vertices[9] = new THREE.Vector3( -10, 0, 2 );
  bodyCollisionCheckBox.geometry.vertices[10] = new THREE.Vector3( -10, -1.5, -2 );
  bodyCollisionCheckBox.geometry.vertices[11] = new THREE.Vector3( -10, -1.5, 2 );
  ...
  geometry = new THREE.PlaneGeometry( 12, 5, 1 );
  material = new THREE.MeshBasicMaterial( {color: 0xffff00, side: THREE.DoubleSide} );
  var wingCollisionCheckPlane1 = new THREE.Mesh( geometry, material );
  wingCollisionCheckPlane1.position.set( 0, -0.1, 5.4 );
  ...
  wingCollisionCheckPlane2.position.set( 0, -0.1, 5.4 );
